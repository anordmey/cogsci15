...
We found that contextual differences lead to significantly different pragmatic judgments across the same true and grammatical negative sentences.   Across two experiments, negative sentences that were more informative---more effective at conveying the intended referent of the sentence---were rated as more felicitous than less informative negative sentences.  This was true across multiple contexts, including different types of negation: Contexts where the referent of negation was nonexistence were rated higher than contexts where the referent of negation was an alternative.  This is consistent with a pragmatic account in which the goal of communication is to convey your intended meaning in the most effective and efficient way possible.  
